...
// Technical Note: Move this array into a standalone data file later to optimize the dev loop entirely.
interface Property {
  id: number;
  title: string;
  category: string;
...
const properties: Property[] = [
  ...
  { id: 3, title: "Hill Farm House", category: "Farm House", location: "Rishikesh", price: "₹2.40 Cr", area: "5,200 sq.ft", bedrooms: "5 BHK", status: "New Launch", image: "/images/resort.jpg" },
...
export default function PropertyGrid() {
  return (
    <section id="properties" className="max-w-[1400px] mx-auto px-6 sm:px-8 py-24 bg-[#FAF9F6]">

      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-76px)] max-w-[1440px] items-center gap-8 px-6 py-12 sm:px-8 lg:grid-cols-[1.02fr_0.98fr] lg:px-12 lg:py-16">
        ...
        >
          ...
          <motion.div
            ...
            className="mb-6 inline-flex items-center gap-2 rounded-brand-badge border border-white/10 bg-white/[0.04] px-4 py-2 text-[10px] font-bold uppercase tracking-[0.25em] text-white/90 backdrop-blur-md"
          >
